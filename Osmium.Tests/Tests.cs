...
public class MinimaxTests
{
    ...
    public void FindBestMove_HangingPieces()
    {
        ...
        Assert.Equal(bestMove, Minimax.Minimax.FindBestMove(position, 1, -1, Minimax.Minimax.DebugPrintMode.ProgressBar, out _));
        //
    ...
    public void FindBestMove_BackRankMates()
    {
        ...
        Assert.Equal(bestMove, Minimax.Minimax.FindBestMove(position, 3, -1, Minimax.Minimax.DebugPrintMode.ProgressBar, out _));
    }
